...
for restart in range(flags.n_restarts):
    ...
    envs = [envs[0], envs[1], envs[2], envs[4], envs[3]]  # Change this line to use different environment as testset.
    ...
    print('Final test set performance (acc) (MLP-IRM):')
